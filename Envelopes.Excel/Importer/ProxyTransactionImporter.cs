...
namespace Envelopes.Persistence.Importer {
    ...
    /// <summary>
    /// Most likely chuck away. This class is here so I can use my ITransactionsImporter interface, but hard code in the retrieval of three different files for my personal use.
    /// </summary>
